...
import { GraduationCap, ChevronRight, Book, Video, Download, MessageCircle, Menu, X } from "lucide-react";
...
// This is the main wrapper component that handles awaiting params
export default async function SubjectPage({ params }: { params: { slug: string } }) {
  ...
  return <SubjectPageClient slug={slug} />;
}

// This is the client component that handles all the React hooks
function SubjectPageClient({ slug }: { slug: string }) {
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6">
              {selectedTopic ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-white/70">
                    Choose a topic from the modules on the left to start learning.
                  </p>
                </div>
              )}
            </div>
